...
#------------------------- Files ----------------------------------------------------------
file_dst  = dir_main + "Distances/Gaussian/Sources_mean.csv"  # Kalkayotl distances
file_pht  = dir_main + "members_run_1.csv"           # File name of the data set
file_out  = dir_main + "Absolute_magnitudes.csv"     # Output file with absolute magnitudes
#-------------------------------------------------------------------------------------------
