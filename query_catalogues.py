...
#=============== Data =======================================================
dir_base = "/home/jolivares/Cumulos/ComaBer/"
file_in  = dir_base + "Mecayotl/iter_0/Classification/members_mecayotl.csv"
file_out = dir_base + "Sakam/data/members_GaiaEDR3+2MASS+PanSTARRS.csv"
#----------------------------------------------------------------------------
...
for cat in catalogues:
	...
	if cat["name"] == "GaiaEDR3":
		a = tmp["input_source_id"].to_numpy()
		b = tmp["source_id"].to_numpy()
		tst = np.all(a == b)
		msg = "Some of the 'source_id's of the \
		Gaia catalogue do not match the input ones"
		assert tst,msg
